...
Install the [package](https://packagist.org/packages/boopathi/shoppingcart) through [Composer](http://getcomposer.org/). 

Run the Composer require command from the Terminal:

    composer require boopathi/shoppingcart
...
use boopathi\Shoppingcart\Contracts\Buyable;
use Illuminate\Database\Eloquent\Model;

class Product extends Model implements Buyable {
    use boopathi\Shoppingcart\CanBeNought;
}
```
...
use boopathi\Shoppingcart\Contracts\InstanceIdentifier;
...
If you want to change these options, you'll have to publish the `config` file.
    ...
    php artisan vendor:publish --provider="boopathi\Shoppingcart\ShoppingcartServiceProvider" --tag="config"

This will give you a `cart.php` config file in which you can make the changes.

To make your life easy, the package also includes a ready to use `migration` which you can publish by running:

    php artisan vendor:publish --provider="boopathi\Shoppingcart\ShoppingcartServiceProvider" --tag="migrations"
