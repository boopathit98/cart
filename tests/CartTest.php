...
namespace boopathi\Tests\Shoppingcart;

use boopathi\cart\Cart;
use boopathi\cart\CartItem;
use boopathi\cart\ShoppingcartServiceProvider;
...
class CartTest extends TestCase
{
    ...
    public function it_will_return_the_cartitem_of_the_added_item()
    {
        ...
        $this->assertEquals('027c91341fd5cf4d2579ffffffa90da', $cartItem->rowId);
    ...
    public function it_can_update_the_quantity_of_an_existing_item_in_the_cart()
    {
        ...
        $cart->update('027c91341fd5cf4d2579ffffffa90da', 2);
    ...
    public function it_can_update_an_existing_item_in_the_cart_from_a_buyable()
    {
        ...
        $cart->update('027c91341fd5cf4d2579ffffffa90da', new BuyableProduct(1, 'Different description'));

        $this->assertItemsInCart(1, $cart);
        $this->assertEquals('Different description', $cart->get('027c91341fd5cf4d2579ffffffa90da')->name);
    ...
    public function it_can_update_an_existing_item_in_the_cart_from_an_array()
    {
        ...
        $cart->update('027c91341fd5cf4d2579ffffffa90da', ['name' => 'Different description']);
    ...
    {
        $this->expectException(\boopathi\cart\Exceptions\InvalidRowIDException::class);
    ...
    public function it_will_regenerate_the_rowid_if_the_options_changed()
    {
        ...
        $cart->update('ea65e0bdcd1967dkdkddkdde780177c0', ['options' => ['color' => 'blue']]);

        $this->assertItemsInCart(1, $cart);
        $this->assertEquals('7e70a1e9aaadddfghj921a07aae5d011', $cart->content()->first()->rowId);
        $this->assertEquals('blue', $cart->get('7e70a1e9aaadddfghj921a07aae5d011')->options->color);
    }
    ...
    public function it_will_add_the_item_to_an_existing_row_if_the_options_changed_to_an_existing_rowid()
    {
        ...
        $cart->update('7e70a1e9aaadddfghj921a07aae5d011', ['options' => ['color' => 'red']]);
    ...
    public function it_can_remove_an_item_from_the_cart()
    {
        ...
        $cart->remove('027c91341fd5cf4d2579ffffffa90da');
    ...
    public function it_will_remove_the_item_if_its_quantity_was_set_to_zero()
    {
        ...
        $cart->update('027c91341fd5cf4d2579ffffffa90da', 0);
    ...
    public function it_will_remove_the_item_if_its_quantity_was_set_negative()
    {
        ...
        $cart->update('027c91341fd5cf4d2579ffffffa90da', -1);
    ...
    public function it_can_get_an_item_from_the_cart_by_its_rowid()
    {
        ...
        $cartItem = $cart->get('027c91341fd5cf4d2579ffffffa90da');
    ...
    public function it_will_include_the_tax_and_subtotal_when_converted_to_an_array()
    {
        ...
        $this->assertInstanceOf(Collection::class, $content);
        $this->assertEquals([
            '027c91341fd5cf4d2579ffffffa90da' => [
                'rowId'    => '027c91341fd5cf4d2579ffffffa90da',
                'id'       => 1,
                'name'     => 'Item name',
                'qty'      => 1,
                'price'    => 10.00,
    ...
    public function it_can_associate_the_cart_item_with_a_model()
    {
        ...
        $cart->associate('027c91341fd5cf4d2579ffffffa90da', new ProductModel());
    ...
    {
        $this->expectException(\boopathi\cart\Exceptions\UnknownModelException::class);
        ...
        $cart->associate('027c91341fd5cf4d2579ffffffa90da', 'SomeModel');
    }
    ...
    public function it_can_calculate_tax_based_on_the_specified_tax()
    {
        ...
        $cart->setTax('027c91341fd5cf4d2579ffffffa90da', 19);
    ...
    {
        $this->expectException(\boopathi\cart\Exceptions\CartAlreadyStoredException::class);
    ...
    public function can_set_cart_item_discount()
    {
        ...
        $cart->add(new BuyableProduct(1, 'First item', 10.00), 1);
        $cartItem = $cart->get('027c91341fd5cf4d2579ffffffa90da');
        $cart->setDiscount('027c91341fd5cf4d2579ffffffa90da', 50);
        $this->assertEquals(50, $cartItem->discountRate);
    }
